...
int main()
{
    ...
    double pctRepub = ( 90.0 * republicanVotes ) / totalVoters; //here, I changed 100 to 90 so now the percent will not be correct as it is now less than the accurate percent 
